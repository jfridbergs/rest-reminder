...
@LargeTest
public class EspressoPreferencesPlus {
    ...
    String workPeriodLengthKey, restPeriodLengthKey, workPeriodSoundKey, restPeriodSoundKey, extendCountKey, extendBaseLengthKey, reminderModeKey, disableBatteryOptKey;
    IntentFilter filter;
    MyReceiver receiver;
    String actualModeSummary, actualWorkLengthSummary, actualRestLengthSummary, actualWorkAudioSummary, actualRestAudioSummary, actualExtendCountSummary, actualExtendLengthSummary, actualDisableBatteryOptSummary;
    String expectedModeSummary, expectedWorkLengthSummary, expectedRestLengthSummary, expectedWorkAudioSummary, expectedRestAudioSummary, expectedExtendCountSummary, expectedExtendBaseLengthSummary, expectedDisableBatteryOptSummary;
    ...
    public void setUp(){
        ...
        expectedOfflineTitle = RReminderTest.getResourceString(R.string.reminder_off_title).toUpperCase();
        ...
        workPeriodLengthKey = RReminderTest.getResourceString(R.string.pref_work_period_length_key);
        restPeriodLengthKey = RReminderTest.getResourceString(R.string.pref_rest_period_length_key);
        workPeriodSoundKey = RReminderTest.getResourceString(R.string.pref_work_period_start_sound_key);
        restPeriodSoundKey = RReminderTest.getResourceString(R.string.pref_rest_period_start_sound_key);
        extendCountKey = RReminderTest.getResourceString(R.string.pref_period_extend_options_key);
        disableBatteryOptKey = RReminderTest.getResourceString(R.string.pref_disable_battery_optimization_key);
        extendBaseLengthKey = RReminderTest.getResourceString(R.string.pref_period_extend_length_key);

        reminderModeKey = RReminderTest.getResourceString(R.string.pref_mode_key);
        ...
        editor.putString(RReminderTest.getResourceString(R.string.pref_work_period_length_key), "00:20");
    ...
    public void testPreferenceDescriptions() {
        ...
        onView(withText(RReminderTest.getResourceString(R.string.pref_screen_periods_title))).perform(click());
        onView(isRoot()).perform(CustomActions.waitFor(1000));
        Espresso.pressBack();
        onView(isRoot()).perform(swipeUp());
        onView(withText(RReminderTest.getResourceString(R.string.pref_screen_period_extend_title))).perform(click());
        onView(isRoot()).perform(CustomActions.waitFor(1000));
        Espresso.pressBack();
        Espresso.pressBack();
        ...
        expectedModeSummary = RReminderTest.getResourceString(R.string.pref_mode_summary_automatic);
        expectedWorkLengthSummary = RReminder.getFormatedValue(getApplicationContext(), 0, preferences.getString(workPeriodLengthKey, RReminderTest.getResourceString(R.string.default_work_length_string)));
        expectedRestLengthSummary = RReminder.getFormatedValue(getApplicationContext(), 0, preferences.getString(restPeriodLengthKey, RReminderTest.getResourceString(R.string.default_rest_length_string)));
        ...
        if(value==1){
            expectedExtendCountSummary=RReminderTest.getResourceString(R.string.pref_options_single);
        } else {
            expectedExtendCountSummary = String.format(RReminderTest.getResourceString(R.string.pref_options_multiple), value);
        }

        value = preferences.getInt(extendBaseLengthKey, RReminder.DEFAULT_EXTEND_BASE_LENGTH);
        if(value==1){
            expectedExtendBaseLengthSummary= RReminderTest.getResourceString(R.string.pref_minute_single);
        } else {
            expectedExtendBaseLengthSummary = getApplicationContext().getString(R.string.pref_minute_multiple, value);
        }

        expectedDisableBatteryOptSummary = RReminderTest.getResourceString(R.string.pref_disable_battery_optimization_prefix);
        boolean disabled = preferences.getBoolean(disableBatteryOptKey, false);
        if(disabled){
            expectedDisableBatteryOptSummary+=" "+RReminderTest.getResourceString(R.string.pref_disable_battery_optimization_disabled);
        } else {
            expectedDisableBatteryOptSummary+=" "+RReminderTest.getResourceString(R.string.pref_disable_battery_optimization_enabled);
        }
       ...
       assertWithMessage("the summary of rest period audio preference should match").that(expectedRestAudioSummary).isEqualTo(actualRestAudioSummary);
        ...
        assertWithMessage("the summary of extend base length preference should match").that(expectedExtendBaseLengthSummary).isEqualTo(actualExtendLengthSummary);
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            assertWithMessage("tthe summary of extend base length preference should match").that(expectedDisableBatteryOptSummary).isEqualTo(actualDisableBatteryOptSummary);
        }
    ...
    public void testShortPeriodPreferenceDisabled(){
        ...
        onView(withId(R.id.inconsistent_behaviour_battery)).check(matches(isDisplayed()));
        onView(isRoot()).perform(CustomActions.waitFor(1000));
        onView(withText("CANCEL")).perform(click());
        onView(isRoot()).perform(CustomActions.waitFor(1000));
        //after clicking OK, device battery optimizations settings are opened (neither dialog or Rest Reminders preference screen is visible)
        //assertWithMessage("batterySettingsdialog is visible").that( batterySettingsDialog.getShowsDialog()).isFalse();
        onView(withId(R.id.inconsistent_behaviour_battery)).check(doesNotExist());
        onView(withText(RReminderTest.getResourceString(R.string.pref_enable_short_periods_title))).check(matches(isDisplayed()));
    ...
    public void testShortPeriodPreference(){
        ...
        onView(withText(RReminderTest.getResourceString(R.string.pref_work_period_length_title))).perform(click());
        ...
        onView(withText(RReminderTest.getResourceString(R.string.pref_rest_period_length_title))).perform(click());
    ...
    public void testUpdatedSummary(){
        ...
        openPreferences();
        intended(hasComponent(PreferenceXActivity.class.getName()));
        onView(withText(RReminderTest.getResourceString(R.string.pref_mode_title) + ": automatic")).perform(click());
        ...
        onView(isRoot()).perform(swipeUp());
        onView(withText(RReminderTest.getResourceString(R.string.pref_screen_period_extend_title))).perform(click());
        onView(withText(RReminderTest.getResourceString(R.string.pref_period_extend_options_title))).perform(click());
        onView(withId(R.id.number_preference_picker)).perform(CustomActions.setValue(2));
        onView(withText("OK")).perform(click());
        onView(withText(RReminderTest.getResourceString(R.string.pref_period_extend_length_title))).perform(click());
        ...
        expectedModeSummary = RReminderTest.getResourceString(R.string.pref_mode_summary_manual);
        expectedWorkLengthSummary = RReminder.getFormatedValue(getApplicationContext(), 0, preferences.getString(workPeriodLengthKey, RReminderTest.getResourceString(R.string.default_work_length_string)));
        expectedRestLengthSummary = RReminder.getFormatedValue(getApplicationContext(), 0, preferences.getString(restPeriodLengthKey, RReminderTest.getResourceString(R.string.default_rest_length_string)));
        ...
        if(value==1){
            ...
            expectedExtendCountSummary= getApplicationContext().getResources().getString(R.string.pref_options_multiple, value);
        }
        ...
        if(value==1){
            ...
            expectedExtendBaseLengthSummary = getApplicationContext().getResources().getString(R.string.pref_minute_multiple, value);
        }
        ...
        assertWithMessage("after updating extend length preference the summary should be updated").that(expectedExtendBaseLengthSummary).isEqualTo(actualExtendLengthSummary);
    }
    ...
    public void testEnablingFunctionality(){
        ...
        openPreferences();
        intended(hasComponent(PreferenceXActivity.class.getName()));
        onView(withText(RReminderTest.getResourceString(R.string.pref_end_period_title))).perform(click());
        onView(withText(RReminderTest.getResourceString(R.string.pref_enable_extend_title))).perform(click());
        Espresso.pressBack();
    ...
    public void testExtendOptionsChanged(){
        editor.putBoolean(RReminderTest.getResourceString(R.string.pref_enable_extend_key), true);
        editor.putString(RReminderTest.getResourceString(R.string.pref_work_period_length_key), "00:05");
        editor.commit();
        ...
        optionOneButton =String.format(RReminderTest.getResourceString(R.string.extend_dialog_button),extendBaseLength);
        optionTwoButton = String.format(RReminderTest.getResourceString(R.string.extend_dialog_button),extendBaseLength*2);
        optionThreeButton =String.format(RReminderTest.getResourceString(R.string.extend_dialog_button),extendBaseLength*3);
    ...
    public void testLedPreference(){
        boolean ledActiveStatus = preferences.getBoolean(getApplicationContext().getResources().getString(R.string.pref_show_led_key), true);
        assertWithMessage("default value of LED preference should be true").that(ledActiveStatus).isTrue();

        openPreferences();
        intended(hasComponent(PreferenceXActivity.class.getName()));
        onView(withText(RReminderTest.getResourceString(R.string.pref_show_led_title))).perform(click());
        Espresso.pressBack();

        ledActiveStatus = preferences.getBoolean(getApplicationContext().getResources().getString(R.string.pref_show_led_key), true);
    ...
    public void changePeriodLengthPreference(int periodType, int hour, int mins){
        switch (periodType){
            ...
            case 99 : {
                onView(withText(RReminderTest.getResourceString(R.string.pref_approx_notification_length_title))).perform(click());
                break;
            }
            default: break;
        }
            ...
            if(intent.getAction()!=null){
                switch(intent.getAction()){
                    ...
                    case RReminder.CUSTOM_INTENT_TEST_PREFERENCES_PERIOD :
                    {
                        ...
                        actualDisableBatteryOptSummary = intent.getExtras().getString(RReminder.PREFERENCE_DISABLE_BATTERY_OPT_SUMMARY);
                        break;
                    }
                    case RReminder.CUSTOM_INTENT_TEST_PREFERENCES_EXTEND :
                    {
                        ...
                        actualExtendLengthSummary = intent.getExtras().getString(RReminder.PREFERENCE_EXTEND_LENGTH_SUMMARY);
                        break;
                    }
                    default: break;
                }
