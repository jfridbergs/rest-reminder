...
@LargeTest
public class EspressoMainActivityPlus {
    ...
    public void testTitleContent(){
        ...
        expectedColor = appContext.getResources().getColor(R.color.white);
        ...
        expectedColor = appContext.getResources().getColor(R.color.black);
        onView(withId(R.id.period_title)).check(matches(CustomMatchers.withTextColor(expectedColor)));
    ...
    public void testNotificationActivityTurnOffButton(){
        ...
        int expectedColor = appContext.getResources().getColor(R.color.black);
    ...
    public void testExtendButton(){
        ...
        String expectedButtonText = getResourceString(R.string.extend_current_period);
        ...
        optionOneButton = String.format(getResourceString(R.string.extend_dialog_button),extendBaseLength);
        optionTwoButton =String.format(getResourceString(R.string.extend_dialog_button),extendBaseLength*2);
        optionThreeButton = String.format(getResourceString(R.string.extend_dialog_button),extendBaseLength*3);
        ...
        int expectedBgColor = appContext.getResources().getColor(R.color.red);
        onView(withId(R.id.drawer_layout)).check(matches(CustomMatchers.withBackgroundColor(expectedBgColor)));
    }
    ...
    public void testExtendDialogOrientationChange(){
        ...
        onView(withText(getResourceString(R.string.extend_dialog_close_dialog_text))).perform(click());
    ...
    public void testTimerButtonLongPress(){
        ...
        boolean alarmUp = (PendingIntent.getBroadcast(appContext, (int)mActivityRule.getActivity().periodEndTimeValue, intent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE) != null);
        ...
        alarmUp = (PendingIntent.getBroadcast(appContext, (int)mActivityRule.getActivity().periodEndTimeValue, intent,PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE) != null);
    ...
    public void testSwipeAreaBehaviour() {
        ...
        int expectedInitialColorId = appContext.getResources().getColor(R.color.work);
        onView(withId(R.id.drawer_layout)).check(matches(CustomMatchers.withBackgroundColor(expectedInitialColorId)));
        String expectedDescription = mActivityRule.getActivity().getResources().getString(R.string.release_text);
        ...
        if(RReminder.isPortrait(getApplicationContext())){
            ...
            try {
                ...
                onView(withId(R.id.drawer_layout)).check(matches(CustomMatchers.withBackgroundColor(expectedColorId)));
                eventTime = SystemClock.uptimeMillis() + 1000;
            ...
            float y7;
            if(RReminder.isTablet(getApplicationContext())){
                y7 = yStart + swipeLength/2f+32;
            } else {
                y7 = yStart + swipeLength/2f+34;
            }
            int y7int = (int)y7;
    ...
    public void testInactiveDigitColors(){
        editor.putString(getResourceString(R.string.pref_rest_period_length_key), "02:00");
        editor.commit();
        int expectedInactiveColor, expectedActiveColor;
        expectedInactiveColor = getApplicationContext().getResources().getColor(R.color.inactive_digit);
        expectedActiveColor = getApplicationContext().getResources().getColor(R.color.black);
    ...
    public void testTimerButtonStartProcess(){
        ...
        intent.setAction(RReminder.ACTION_ALARM_PERIOD_END);
        onView(isRoot()).perform(CustomActions.waitFor(2000));
        boolean alarmUp = (PendingIntent.getBroadcast(getApplicationContext(), 0, intent,PendingIntent.FLAG_NO_CREATE | PendingIntent.FLAG_IMMUTABLE) != null);
        Log.d(debug, "is alarm up in offline mode: "+alarmUp);
        if(alarmUp){
            Log.d(debug, "PendingIntent at the start: "+PendingIntent.getBroadcast(appContext, 0, intent,PendingIntent.FLAG_NO_CREATE | PendingIntent.FLAG_IMMUTABLE).toString());
        }
        assertWithMessage("the alarm manager shouldn't be running when app is lauched").that(alarmUp).isFalse();

        onView(withId(R.id.timer_layout)).perform(click());
        onView(isRoot()).perform(CustomActions.waitFor(5000));
        alarmUp = (PendingIntent.getBroadcast(getApplicationContext(), (int)mActivityRule.getActivity().periodEndTimeValue, intent,PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE) != null);
        assertWithMessage("the alarm is set").that(alarmUp).isTrue();
        if (alarmUp) {
            Log.d(debug, "Alarm is already active");
            Log.d(debug, "PendingIntent after lauching reminder: "+PendingIntent.getBroadcast(getApplicationContext(), (int)mActivityRule.getActivity().periodEndTimeValue, intent,PendingIntent.FLAG_ONE_SHOT| PendingIntent.FLAG_IMMUTABLE).toString());
        }
    ...
    public void testDescription(){
        ...
        editor.putBoolean(getApplicationContext().getResources().getString(R.string.pref_enable_extend_key), true);
        editor.commit();
        ...
        expectedDescription = getApplicationContext().getResources().getString(R.string.description_extended_one_time);
        onView(withId(R.id.description_text)).check(matches(withText(expectedDescription)));
        expectedColor = getApplicationContext().getResources().getColor(R.color.black);
        ...
        onView(withId(R.id.button_period_end_extend)).perform(click());
        onView(withId(R.id.extend_dialog_button_extend)).perform(click());
        expectedDescription = String.format(getApplicationContext().getResources().getString(R.string.description_extended),2);
        onView(withId(R.id.description_text)).check(matches(withText(expectedDescription)));
        //extending 3rd time for 5 mins
        onView(withId(R.id.button_period_end_extend)).perform(click());
        onView(withId(R.id.extend_dialog_button_extend)).perform(click());
        expectedDescription = String.format(getApplicationContext().getResources().getString(R.string.description_extended),3);
        onView(withId(R.id.description_text)).check(matches(withText(expectedDescription)));
    }
    ...
    public void testServiceUpdatedAfterExtending(){
        ...
        long extendedPeriodEndTime = extendedTimeStamp + 60000*preferences.getInt(getResourceString(R.string.pref_period_extend_length_key),5);
    ...
    public void testNotificationCloseAppInFocus(){
        ...
        int expectedBgColor = appContext.getResources().getColor(R.color.rest);
        onView(withId(R.id.drawer_layout)).check(matches(CustomMatchers.withBackgroundColor(expectedBgColor)));
    }

    @Test
    public void testNotificationCloseAppInFocusManual(){
        editor.putString(getResourceString(R.string.pref_mode_key), "1");
