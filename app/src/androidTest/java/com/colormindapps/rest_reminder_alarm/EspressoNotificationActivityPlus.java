...
@LargeTest
public class EspressoNotificationActivityPlus {
    ...
    public void tearDown(){
        ...
        editor.putString(RReminderTest.getResourceString(R.string.pref_rest_period_length_key), RReminder.DEFAULT_REST_PERIOD_STRING);
    ...
    public void testExtendWorkSingleDescription(){
        ...
        int expectedColor = getApplicationContext().getResources().getColor(R.color.black);
        onView(withId(R.id.notification_extend_description)).check(matches(CustomMatchers.withTextColor(expectedColor)));
        String expectedText = String.format(RReminderTest.getResourceString(R.string.notification_end_extend_description_once),"work");
    ...
    public void testExtendRestSingleDescription(){
        ...
        String expectedText = String.format(RReminderTest.getResourceString(R.string.notification_end_extend_description_once),"rest");
        onView(withId(R.id.notification_extend_description)).check(matches(withText(expectedText)));
    }
    ...
    public void testExtendWorkMultipleDescription(){
        ...
        String expectedText = String.format(RReminderTest.getResourceString(R.string.notification_end_extend_description_multiple),"work",3);
        onView(withId(R.id.notification_extend_description)).check(matches(withText(expectedText)));
    }
    ...
    public void testExtendRestMultipleDescription(){
        ...
        String expectedText = String.format(RReminderTest.getResourceString(R.string.notification_end_extend_description_multiple),"rest",3);
        onView(withId(R.id.notification_extend_description)).check(matches(withText(expectedText)));
    }
    ...
    public void testDescription(){
        ...
        String expectedText = String.format(RReminderTest.getResourceString(R.string.next_period_end_description),"rest","23:30");
        ...
        expectedText = String.format(RReminderTest.getResourceString(R.string.next_period_end_description), "work","23:30");
        onView(withId(R.id.notification_description)).check(matches(withText(expectedText)));
        onView(withId(R.id.notification_description)).check(matches(CustomMatchers.withEnoughSpace()));
    ...
    public void testNotificationManualMode(){
        editor.putString(RReminderTest.getResourceString(R.string.pref_mode_key), "1");
        editor.commit();
        mActivityRule.finishActivity();
        ...
        String expectedText = String.format(RReminderTest.getResourceString(R.string.notification_end_manual_title), "rest");
        onView(withId(R.id.notification_description)).check(matches(withText(expectedText)));
        onView(withId(R.id.notification_description)).check(matches(CustomMatchers.withEnoughSpace()));
        ...
        expectedText = String.format(RReminderTest.getResourceString(R.string.notification_end_manual_title), "work");
        onView(withId(R.id.notification_description)).check(matches(withText(expectedText)));
        onView(withId(R.id.notification_description)).check(matches(CustomMatchers.withEnoughSpace()));
    ...
    public void testWorkPeriod3rdExtend(){
        ...
        onView(isRoot()).perform(CustomActions.waitFor(1000));
        String expectedTitle = RReminderTest.getResourceString(R.string.on_work_period).toUpperCase();;
        onView(withId(R.id.period_title)).check(matches(withText(expectedTitle)));

        String expectedDescription = String.format(RReminderTest.getResourceString(R.string.description_extended),4);
        onView(withId(R.id.description_text)).check(matches(withText(expectedDescription)));

        int expectedBgColor = getApplicationContext().getResources().getColor(R.color.red);
    ...
    public void testRestPeriod3rdExtend(){
        ...
        String expectedTitle = RReminderTest.getResourceString(R.string.on_rest_period).toUpperCase();;
        onView(withId(R.id.period_title)).check(matches(withText(expectedTitle)));
        String expectedDescription = String.format(RReminderTest.getResourceString(R.string.description_extended),4);
        onView(withId(R.id.description_text)).check(matches(withText(expectedDescription)));
        int expectedBgColor = getApplicationContext().getResources().getColor(R.color.red);
    ...
    public void testExtendButton(){
        String expectedButtonText = RReminderTest.getResourceString(R.string.extend_current_period);
        ...
        editor.putInt(RReminderTest.getResourceString(R.string.pref_period_extend_options_key), 2);
        editor.commit();
    ...
    public void testExtendDialogOrientationChange(){
        ...
        editor.commit();
        onView(withId(R.id.button_notification_period_end_extend)).perform(click());
        String optionOneButton = String.format(RReminderTest.getResourceString(R.string.extend_dialog_button),extendBaseLength);
        onView(withText(optionOneButton)).check(matches(isDisplayed()));
        ...
        onView(withText(RReminderTest.getResourceString(R.string.extend_dialog_close_dialog_text))).perform(click());
    ...
    public void testTime24HourFormat(){
        ...
        String expectedTimeString = String.format(RReminderTest.getResourceString(R.string.next_period_end_description),"rest",periodEndTime);
